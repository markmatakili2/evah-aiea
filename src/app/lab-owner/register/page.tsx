...
export default function LabOwnerRegisterPage() {
  ...
  const handleFinishRegistration = () => {
    toast({
      ...
      description: "Welcome! Please complete your lab verification to start receiving requests.",
      duration: 5000,
    });
        ...
        <Card className="shadow-2xl">
          {step === 1 && (
            <form onSubmit={handleProceedToVerification}>
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-headline">Lab Owner Registration</CardTitle>
                <CardDescription>Register your lab to join our network.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="lab-name" placeholder="City Central Labs" required />
                  </div>
                   <div className="space-y-2">
                    <Label htmlFor="owner-name">Owner's Full Name</Label>
                    <Input id="owner-name" placeholder="Jane Doe" required />
                  </div>
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <Input id="phone" type="tel" placeholder="+254 712 345 678" required value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} />
                  </div>
                  <div className="space-y-2 md:col-span-2">
              ...
              <CardFooter className="flex flex-col gap-4">
                ...
                <div className="text-center text-sm text-muted-foreground">
                  ...
                  <Link href="/lab-owner/login" className="font-semibold text-primary hover:underline">
                    Log In
                  </Link>
                </div>
              </CardFooter>
          ...
          {step === 2 && (
           ...
           {step === 3 && (
             <>
              <CardHeader className="text-center">
                <CardTitle className="text-2xl font-headline">Partner Terms of Service</CardTitle>
                <CardDescription>Please read and accept our partner terms before proceeding.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <ScrollArea className="h-64 w-full rounded-md border p-4">
                    <h3 className="font-bold mb-2">1. Partnership Agreement</h3>
                    <p className="text-sm">By registering your lab, you agree to provide accurate and timely analysis for all samples received through the DigiLab Connect platform. You commit to upholding quality standards and regulatory compliance.</p>
                    <h3 className="font-bold mt-4 mb-2">2. Penalties</h3>
                ...
                <div className="flex items-center space-x-2">
                    ...
                    >
                        I have read and agree to the lab partner terms of service.
                    </label>
                </div>
              </CardContent>
              <CardFooter>
